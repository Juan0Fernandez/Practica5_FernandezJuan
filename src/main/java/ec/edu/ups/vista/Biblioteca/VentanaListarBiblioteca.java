...
public class VentanaListarBiblioteca extends javax.swing.JInternalFrame {
    ...
    public VentanaListarBiblioteca(BibliotecaControlador bibliotecaControlador) {
        ...
        tituloOriginal = "Listar Bibliotecas";
    ...
    public void cambiarIdioma(Locale locale) {
        ...
        setTitle(mensajes.getString("tituloListarBibliotecas"));

        tblBibliotecas.getColumnModel().getColumn(0).setHeaderValue(mensajes.getString("Codigo"));
        tblBibliotecas.getColumnModel().getColumn(1).setHeaderValue(mensajes.getString("Nombre"));
        tblBibliotecas.getColumnModel().getColumn(2).setHeaderValue(mensajes.getString("Direccion"));
        tblBibliotecas.getColumnModel().getColumn(3).setHeaderValue(mensajes.getString("Telefono"));
    ...
    public void cargarDatos() {
        ...
        for (Biblioteca biblioteca : bibliotecas) {
            Object[] rowData = {biblioteca.getId(), biblioteca.getNombre(), biblioteca.getDireccion(), biblioteca.getTelefono()};
